...
class index_header_banners extends AdminRestfulController {
  ...
  public function index () {
    ...
    return $this->view->setPath ('admin/index_header_banners/index.php')
  ...
  public function add () {
    return $this->view->setPath ('admin/index_header_banners/add.php');
  }
  ...
  public function edit ($obj) {
    return $this->view->setPath ('admin/index_header_banners/edit.php');
  }
